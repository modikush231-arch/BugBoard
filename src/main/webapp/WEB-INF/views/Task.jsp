...
<div class="container mt-5">
    ...
    <!-- Search Box (same alignment as ModuleList) -->
    ...
    <div class="card shadow-sm">
        <div class="card-body">
            <div class="table-responsive">
                <table class="table table-bordered table-hover align-middle text-center" id="taskTable">
...
<!-- Search Filter Script (same logic as ModuleList) -->
<script>
