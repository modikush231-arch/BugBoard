...
<c:set var="pageTitle" value="Update Assignment (Admin)" scope="request" />
...
<main class="main-content" id="mainContent">
    ...
    <div class="row justify-content-center">
                    ...
                    <div class="row g-4">
                        ...
                        <div class="col-md-6">
                            ...
                            <select name="assignStatus" class="form-select bg-dark text-white border-secondary" required>
                                <option value="1" ${taskUser.assignStatus == 1 ? 'selected' : ''}>Active</option>
        ...
        <a href="${pageContext.request.contextPath}/taskUserList" class="btn btn-secondary">
