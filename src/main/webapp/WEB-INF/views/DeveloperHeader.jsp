...
<title>${pageTitle != null ? pageTitle : 'Developer Dashboard'} | BugBoard</title>
...
<button class="navbar-toggler border-0 text-white d-lg-none me-2"
...
<span class="fw-bold text-white">BugBoard Developer</span>
