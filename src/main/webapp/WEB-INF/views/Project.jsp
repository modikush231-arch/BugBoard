                    ...
                    <tbody>
                        <c:forEach var="project" items="${projectList}">
                            <tr>
                                ...
                                <td>
                                    <a href="${project.docURL}" target="_blank" class="btn btn-sm btn-info text-white">
                                        View Doc
                                    </a>
                                </td>
                                ...
                                <td>${project.projectCompetionDate}</td>
                                <td>
                                    <a href="viewProject/${project.id}" class="btn btn-sm btn-primary btn-custom">View</a>
                                    <a href="editProject/${project.id}" class="btn btn-sm btn-warning btn-custom">Update</a>
