...
<main class="main-content" id="mainContent">
    ...
    <div class="mb-4">
        <a href="../projectListPM" class="text-decoration-none text-secondary">
        ...
        <div class="col-lg-8">
            <div class="glass-card p-4">
                ...
                <div class="d-flex justify-content-end gap-2">
                    <a href="../editProjectPM/${project.projectId}" class="btn btn-warning">
                        <i class="bi bi-pencil-square me-1"></i> Edit
                    </a>
                    <a href="../projectModules/${project.projectId}" class="btn btn-info">
                        <i class="bi bi-collection me-1"></i> View Modules
                    </a>
                    <a href="../projectListPM" class="btn btn-secondary">
